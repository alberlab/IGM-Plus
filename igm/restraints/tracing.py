...
class Tracing(Restraint):
    """
    Add TRACING restraint to the MODEL class: the Assignment/input_file gave us a list of "target" (x,y,z) positions for a set of (phased) i loci and the structure index. 
    ...
    Parameters
    ----------
    assignment_file : TRACING activation position file
